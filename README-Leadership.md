...
Founder and President of GiDanc AI LLC, building **AI Assess Tech** — the runtime behavioral governance and assessment platform for deployed AI systems. Senior technology leader with 17+ years driving digital transformation and AI innovation across enterprise environments. Demonstrated track record of delivering $50M+ in measurable business value through strategic program management, AI implementation, and process optimization. Sole inventor on three USPTO provisional patent applications covering eight inventions in AI behavioral assessment and governance.

**LinkedIn:** <https://www.linkedin.com/in/spehargreg/>
**AI Assess Tech:** <https://aiassesstech.com>
**GiDanc AI:** <https://gidanc.ai>

---

## Professional Experience

### **Founder & President | GiDanc AI LLC — building AI Assess Tech**

*2024 - Present | Austin, Texas*

**Key Achievements:**

* Founded and built **AI Assess Tech**, the runtime behavioral governance and assessment platform that measures deployed AI behavior across four dimensions — Lying, Cheating, Stealing, and Harm (LCSH) — using a 120-question psychometric framework with cryptographically verified results anchored to Ethereum
* Sole inventor on **three USPTO provisional patent applications** (63/949,454; 63/985,442; 63/988,410) covering eight inventions assigned to GiDanc AI LLC, including the LCSH framework, multi-agent assessment architecture, hierarchical ethics, compliance infrastructure, and the independent conscience agent
* Deployed a six-agent runtime governance fleet (Jessie, Nole, Grillo, Noah, Sam, Mighty Mark) with constitutional separation of powers as a hard architectural constraint
* Authored **two IEEE papers** (2026): *"Yellow Brick Road to AGI"* (co-authored with Akshay Mittal, accepted to conference) and *"Responsible AI Horizons: A Multi-Dimensional Framework"* (under revision)
* Defined the **"Competent Psychopath" problem** — AI that executes tasks efficiently while making unfair or harmful decisions invisibly — as the central category AI Assess Tech solves
* Established the runtime-vs-training-time distinction as the platform's core competitive moat: no competitor combines runtime behavioral assessment, flight-plan trajectory monitoring, ethical dead-reckoning, constitutional separation of temporal authority, and hash-chain-verified integrity with Ethereum anchoring
* [https://aiassesstech.com](https://aiassesstech.com) | [https://gidanc.ai](https://gidanc.ai)
...
* Evolved into AI Assess Tech in 2024 as the company's flagship platform
* [https://gidanc.ai](https://gidanc.ai)

### **Senior Program Manager | Farm Credit Bank of Texas**

*November 2020 - Present (5+ years) | Austin, Texas*
...
* **Runtime AI Behavioral Governance**: LCSH assessment framework, multi-agent architectures, constitutional separation of powers, Ethereum anchoring for cryptographic integrity
* **AI & Machine Learning**: MindStudio L3 Certified, AI governance, LLM implementation, runtime behavioral assessment
...
* **Patent Portfolio**: Three USPTO provisional applications, eight inventions in AI behavioral governance
* **Product Development**: Founded AI Assess Tech; conceived and launched VibeCoder platform
...
**USPTO Provisional Patent Applications (Sole Inventor, Assigned to GiDanc AI LLC):**

* **63/949,454** — LCSH Behavioral Assessment Framework
* **63/985,442** — Multi-Agent AI Assessment Architecture & Hierarchical Ethics
* **63/988,410** — Compliance Infrastructure & Independent Conscience Agent

Eight total inventions covering runtime behavioral governance, multi-agent assessment, hierarchical ethics, compliance infrastructure, and the constitutional separation of powers governing agent interactions. Non-provisional conversion deadline: December 2026.
...
*Available for consulting, strategic partnerships, executive advisory roles, and AI behavioral assessment engagements*
